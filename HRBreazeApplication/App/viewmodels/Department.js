...
define([
  ...
  function (datacontext, router) {
      ...
      var columns = [{ name: 'Id', index: 'id', sortable: true, width: '10%' },
                     { name: 'Name', index: 'name', sortable: true, width: '90%' }
      ];
      ...
      var gotoDetails = function (selectedRecord) {
          if (selectedRecord && selectedRecord.id()) {
              var url = "#/DepartmentDetails/" + selectedRecord.id();
      ...
      function getdata(forceLocally) {
          return datacontext.getFilterBy(entities, totalPages, currentPage() - 1, totalrecords, orderby, sortOrder, entity, isBusy, filterBy, forceLocally, 'Departmants');
      }
