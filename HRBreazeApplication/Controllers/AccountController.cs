...
//copied from standard mvc4 project and removed open auth etc because it was not needed simply add the references and uncomment below and things will work if needed

namespace HRBreazeApplication.Controllers
{
    [Authorize]
    //[InitializeSimpleMembership]     //add this back if you want to create the db every time
